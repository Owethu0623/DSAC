...
export function generateOfficialKpis(entities: PublicEntity[]): KPIRecord[] {
  ...
  entities.forEach(entity => {
    ...
    // Custom Gazetted KPIs for Ubuntu Arts NPO
    if (entity.id === 'ent-ubuntu-arts') {
      allKpis.push(
        {
          id: `kpi-${entity.id}-1`,
          entityId: entity.id,
          ...
          name: 'Community arts programmes implemented',
          description: 'Grassroots community arts and cultural development programmes rolled out across targeted sub-districts.',
          unitOfMeasure: 'Programmes',
          baseline: 12,
          annualTarget: 15,
          q1Target: 4,
          q1Actual: 4,
          ...
          status: 'ON_TRACK',
          historicalPerformance: [
            { year: '2022/2023', target: 12, achieved: 12 },
            { year: '2023/2024', target: 14, achieved: 14 },
            { year: '2024/2025', target: 16, achieved: 16 },
          ],
        },
        {
          id: `kpi-${entity.id}-2`,
          ...
          name: 'Youth participants in grassroots development',
          description: 'Unemployed youth and emerging creatives engaged in certified arts incubation and skills programmes.',
          unitOfMeasure: 'Youth Participants',
          baseline: 800,
          annualTarget: 1000,
          q1Target: 250,
          q1Actual: 280,
          ...
          status: 'ON_TRACK',
          historicalPerformance: [
            { year: '2022/2023', target: 800, achieved: 840 },
            { year: '2023/2024', target: 950, achieved: 980 },
            { year: '2024/2025', target: 1100, achieved: 1150 },
          ],
        },
        {
          id: `kpi-${entity.id}-3`,
          entityId: entity.id,
          entityName: entity.name,
          programmeName: 'Artisan & Skills Transfer Academy',
          name: 'Artisan & cultural workshops conducted',
          description: 'Specialised masterclasses and heritage craftsmanship training sessions delivered.',
          unitOfMeasure: 'Workshops',
          baseline: 16,
          annualTarget: 20,
          q1Target: 5,
          ...
          status: 'ON_TRACK',
          historicalPerformance: [
            { year: '2022/2023', target: 18, achieved: 18 },
            { year: '2023/2024', target: 20, achieved: 20 },
            { year: '2024/2025', target: 24, achieved: 24 },
          ],
        },
        {
          id: `kpi-${entity.id}-4`,
          entityId: entity.id,
          entityName: entity.name,
          programmeName: 'Institutional Governance & Compliance',
          name: 'Partnerships established and statutory audits completed',
          description: 'Formal inter-institutional partnerships established and unqualified PFMA compliance audit opinions attained.',
          unitOfMeasure: 'Deliverables',
          baseline: 3,
          annualTarget: 5,
          q1Target: 1,
          q1Actual: 1,
          ...
          status: 'ON_TRACK',
          historicalPerformance: [
            { year: '2022/2023', target: 1, achieved: 1 },
            { year: '2023/2024', target: 1, achieved: 1 },
            { year: '2024/2025', target: 1, achieved: 1 },
          ],
        }
      );
      return;
